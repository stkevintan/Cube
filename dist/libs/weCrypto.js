...
var mm = (function () {
    ...
    function rsaEncrypt(text, exponent, modulus) {
        ...
        var pem = '-----BEGIN RSA PUBLIC KEY-----\n' +
            ...
            '-----END RSA PUBLIC KEY-----';
        var key1 = new nrsa(pem, {
            encryptionScheme: 'pkcs1'
        });
        var key2 = new nrsa(pem, {
            encryptionScheme: 'pkcs1_oaep'
        });
        console.log(key1.isPublic());
        var encText2 = key1.encrypt(text, 'hex', 'utf8');
        console.log(encText2);
        return key2.encrypt(text, 'hex', 'utf8')
    }
...
module.exports = mm;
console.log(mm.aesRsaEncrypt(JSON.stringify({phone: 182671232, password: '2783213adsfdarev'})).encSecKey);